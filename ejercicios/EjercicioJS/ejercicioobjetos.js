...
function init() {
    ...
    var Cliente = function () {
        this.nombre = "Juan";
        this.direccion = "Calle Juan Bravo 49";
        this.email = "juan.bravo@gmail.com";
        this.tlf = "687 847 111";
        this.contacto = "Pedro";
    }

    var cliente1 = new Cliente();
    var cliente2 = new Cliente("Pedro", "Calle Diego de Leon 49", "pedro.leon@gmail.com", "687 847 222");
